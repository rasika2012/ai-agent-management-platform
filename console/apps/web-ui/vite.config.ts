...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: '@wso2/amp-core-ui/dist/index.css', replacement: path.resolve(__dirname, '../../workspaces/core-ui/dist/index.css') },

      // Resolve core-ui and all its sub-packages to source for hot-reload
      { find: '@wso2/amp-core-ui', replacement: path.resolve(__dirname, '../../workspaces/core-ui/src') },
